...
public class CustomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CustomeAdapter(Context context, String userId, List<Items> userMessagesList) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case ROW_TYPE_LOAD_EARLIER_MESSAGES:
                return new ProgressViewHolder(mLayoutInflater.inflate(R.layout
                        .progress_item, parent, false));
            case ROW_TYPE_SENDER:
                return new SenderMsgViewHolder(mLayoutInflater.inflate(R.layout.row_type_sender,
                        parent, false));
            case ROW_TYPE_SENDER_IMAGE:
                return new SenderImgViewHolder(mLayoutInflater.inflate(R.layout.row_type_sender_image,
                        parent, false));
            ...
            case ROW_TYPE_RECEIVER_IMAGE:
                return new ReceiverImgViewHolder(mLayoutInflater.inflate(R.layout
                        .row_type_receiver_image, parent, false));
            case ROW_TYPE_TITLE:
                return new TitleViewHolder(mLayoutInflater.inflate(R.layout
                        .row_type_title, parent, false));
            case ROW_TYPE_DATE:
                return new DateViewHolder(mLayoutInflater.inflate(R.layout
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ROW_TYPE_LOAD_EARLIER_MESSAGES:
                ProgressViewHolder loadEarlierMsgsViewHolder =
            ...
            case ROW_TYPE_SENDER:
                ...
                break;
            case ROW_TYPE_SENDER_IMAGE:
                SenderImgViewHolder senderImgViewHolder = (SenderImgViewHolder) holder;
                if (userMessagesList.get(position).getContentType().equals("sending")){
...
//                            .into(senderImgViewHolder.img);
            ...
            case ROW_TYPE_RECEIVER:
                ...
                break;
            case ROW_TYPE_RECEIVER_IMAGE:
                ReceiverImgViewHolder receiverImgViewHolder = (ReceiverImgViewHolder) holder;
                Picasso.with(mContext).
                        load(userMessagesList.get(position).getContent())
                        .memoryPolicy(MemoryPolicy.NO_CACHE)
                        .placeholder(R.drawable.default_loader)
